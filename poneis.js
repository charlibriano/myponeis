...
,
  /* ---- elenco ampliado: pôneis que já têm imagem baixada ----
     as cores servem só para o desenho SVG, caso a imagem falte  */
  {nome:'Diamond Tiara',    art:'a', pelo:'#F2A8C4', crina:['#B48FD8','#E8E4EE'], olho:'#6FA8D8', tipo:'terrestre', nivel:1},
  {nome:'Silver Spoon',     art:'a', pelo:'#D8D8DE', crina:['#B0B0BC','#E8E8EE'], olho:'#7FB0D8', tipo:'terrestre', nivel:1},
  {nome:'Cheerilee',        art:'a', pelo:'#E8A8C0', crina:['#8E5BA8','#D86FA8'], olho:'#6FB07E', tipo:'terrestre', nivel:1},
  {nome:'Lyra Heartstrings',art:'a', pelo:'#C4E8D8', crina:['#E8F0E0','#9AD8C0'], olho:'#E8C24B', tipo:'unicornio', nivel:1},
  {nome:'DJ Pon-3',         art:'a', pelo:'#F2F2F5', crina:['#5FC4E8','#4A9FD8'], olho:'#E4574F', tipo:'unicornio', nivel:1},
  {nome:'Octavia Melody',   art:'a', pelo:'#C4BEB8', crina:['#3A3236'], olho:'#8E5BD0', tipo:'terrestre', nivel:1},

  {nome:'Babs Seed',        art:'a', pelo:'#E8B07E', crina:['#B04A3E'], olho:'#7EB08E', tipo:'terrestre', nivel:2},
  {nome:'Coco Pommel',      art:'a', pelo:'#E8DCC4', crina:['#3A4A6E'], olho:'#7FA8D8', tipo:'terrestre', nivel:2},
  {nome:'Sunburst',         art:'o', pelo:'#F2C48E', crina:['#D8763E'], olho:'#6FA8D8', tipo:'unicornio', nivel:2},
  {nome:'Flurry Heart',     art:'a', pelo:'#F5D8E8', crina:['#8E7FD0','#E8A8C8'], olho:'#A87FD8', tipo:'alicornio', nivel:2},

  {nome:'Twist',            art:'a', pelo:'#F2E0C4', crina:['#D8544A'], olho:'#7FB0D8', tipo:'terrestre', nivel:3},
  {nome:'Pipsqueak',        art:'o', pelo:'#F2EAE0', crina:['#8E6A4A'], olho:'#7EB08E', tipo:'terrestre', nivel:3},
  {nome:'Gilda',            art:'a', pelo:'#E8D8A8', crina:['#B08E5E'], olho:'#E8A83E', tipo:'terrestre', nivel:3}
];
